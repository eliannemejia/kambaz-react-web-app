...
export default function Quizzes() {
    return (
        <Container id="wd-quizzez">
            <QuizzesControls /><br />
            <ListGroup className="rounded-0" id="wd-quizzes">
                <ListGroup.Item className="wd-quizzes-title p-0 mb-5 fs-5 border-gray" id="wd-quizzes-title">
                    ...
                    <ListGroup className="wd-quizzes rounded-0">
                        <ListGroup.Item className="green-left-border p-3 ps-1 d-flex align-items-center">
                            ...
                            <div className="float-end wd-margin-left" >
                                <Link to="/Kambaz/Courses/1234/Quizzes/123" id="wd-quiz-link"
