...
export default function AssignmentEditor() {
    ...
    const handleSave = () => {
        ...
        else { dispatch(updateAssignment({ ...assignment })); } navigate(`/Kanbas/Courses/${cid}/Assignments`);
    };
    return (<div id="wd-assignments-editor" className="me-4">
        <div>
            ...
            <textarea id="wd-description" className="form-control mb-4" onChange={(e) => dispatch(setAssignment({ ...assignment, description: e.target.value }))} >
                {assignment.description}        </textarea>                <div className="row">
                <label htmlFor="wd-points" className="col"><span className="float-end me-2">Points</span></label>
                <input id="wd-points" defaultValue={assignment.points} className="form-control mb-3 col" onChange={(e) => dispatch(setAssignment({ ...assignment, points: e.target.value }))} />
            </div>
            <div className="row">
                ...
                <select id="wd-group" name="Assignment Groups" className="form-select mb-3 col">
                    <option value="option1">ASSIGNMENTS</option>                    </select>
            ...
            <div className="row">
                ...
                <div className="border border-secondary rounded p-3 mb-3 col">
                    ...
                    <label htmlFor="wd-text-entry" className="form-check-label mb-2">Text Entry</label>
                    <input type="checkbox" name="check-genre" id="wd-website-url" className="form-check-input me-2" />
                    <label htmlFor="wd-webiste-url" className="form-check-label mb-2">Website URL</label>
                    <input type="checkbox" name="check-genre" id="wd-media-recordings" className="form-check-input me-2" />
                    <label htmlFor="wd-media-recordings" className="form-check-label mb-2">Media Recordings</label>
                    <input type="checkbox" name="check-genre" id="wd-student-annotation" className="form-check-input me-2" />
                    <label htmlFor="wd-student-annotation" className="form-check-label mb-2">Student Annotation</label>
            ...
            <div className="row">
                ...
                <div className="border border-secondary rounded p-3 mb-3 col">
                    ...
                    <input type="datetime-local" id="wd-due-date" defaultValue={assignment.due} onChange={(e) => dispatch(setAssignment({ ...assignment, due: e.target.value }))} className="form-control mb-2" />
                    <div className="row">
                        <div className="col">
                            <label htmlFor="wd-available-from"><b>Available From</b></label>
                            <input type="datetime-local" id="wd-available-from" defaultValue={assignment.unlock} className="form-control mb-2" onChange={(e) => dispatch(setAssignment({ ...assignment, unlock: e.target.value }))} />
                        </div>
                        <div className="col">
