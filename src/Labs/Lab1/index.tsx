    ...
    return (
        <div id="wd-lab1">
            ...
            <div id="wd-h-tag">
                ...
                is preceded by the heading Heading Tags. The font of the section headings are usually larger
                and bolder than their subsection headings. This document uses headings to introduce topics
                such as HTML Documents, HTML Tags, Heading Tags, etc. HTML heading tags can be used to
                format plain text so that it renders in a browser as large headings. There are 6 heading
                tags for different sizes: h1, h2, h3, h4, h5, and h6. Tag h1 is the largest heading and
            ...
            <div id="wd-p-tag">
                ...
                <p id="wd-p-1">
                    ...
                    set of sentences. To force the browser to add vertical spacing, wrap the paragraphs you want
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>Scoop about a serving of Greek yogurt into a bowl</li>
                    <li>Add a scoop of protein powder</li>
                    <li>Add about a tablespoon of sugar free pudding mix</li>
                    <li>Add a pinch of baking powder</li>
            ...
            <div id="wd-forms">
                ...
                <h4>1.2.7.3 Creating Interactive Buttons with HTML</h4>
                ...
                <h4>1.2.7.4 Creating Exclusive Choices with HTML Radio Buttons</h4>
                ...
                <h4>1.2.7.5 Creating Multiple Selections with HTML Checkboxes</h4>
            ...
            <div id="wd-navigation">
                ...
                to get dummy text<br />
                 ...
                 Please <a href = "https://github.com/eliannemejia/kambaz-react-web-app" id = "wd-github"> click here </a>
                 to see my code repository<br />
            </div>
